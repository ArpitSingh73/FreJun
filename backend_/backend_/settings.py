"""
Django settings for backend_ project.
...
SECRET_KEY = 'django-insecure-1!1q4iuj@oez38k#_9ha1$i^w0)h%o(cjr+(4rt#a58#mx1=@_'
...
INSTALLED_APPS = [
    ...
    'expense_tracker',  # Your app for expense tracking
    'rest_framework',
